...
void _taskSerialize(
  ...
  writer.writeDateTime(offsets[3], object.runDate);
}
...
Task _taskDeserialize(
  ...
  object.runDate = reader.readDateTime(offsets[3]);
  return object;
}
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> runDateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'runDate',
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> runDateGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> runDateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> runDateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskQuerySortBy on QueryBuilder<Task, Task, QSortBy> {
  ...
  QueryBuilder<Task, Task, QAfterSortBy> sortByRunDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'runDate', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByRunDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'runDate', Sort.desc);
    });
  }
}
...
extension TaskQuerySortThenBy on QueryBuilder<Task, Task, QSortThenBy> {
  ...
  QueryBuilder<Task, Task, QAfterSortBy> thenByRunDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'runDate', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByRunDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'runDate', Sort.desc);
    });
  }
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
  ...
  QueryBuilder<Task, Task, QDistinct> distinctByRunDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'runDate');
    });
  }
}
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, DateTime, QQueryOperations> runDateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'runDate');
    });
  }
}
